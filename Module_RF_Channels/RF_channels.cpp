...
int main(int argc, char** argv)
{
    ...
    long int _lat=-90, _long=-180, _height=2000; // Setting minimum values for Lattitudes, Longitudes and Height
    
    // Finding the total number of satellites and their positions
